...
class MyHook:
    def __init__(self, config_path="hotkey_map.yml"):
        ...
        self._key_map = {}  # {key:(feature,keep_old_key)}
    ...
    def key_binding_status(self):
        ...
        for key, (feature, keep_old_key) in self._key_map.items():
            # feature: base_feature.BaseFeature
